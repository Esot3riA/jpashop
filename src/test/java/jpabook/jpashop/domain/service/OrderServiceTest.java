...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("상품 주문 시 상태는 ORDER 이어야 한다.", OrderStatus.ORDER, foundOrder.getStatus());
        assertEquals("주문한 상품 종류 수가 정확해야 한다.", 1, foundOrder.getOrderItems().size());
        assertEquals("주문 가격은 가격 * 수량이어야 한다.", 10000 * orderCount, foundOrder.getTotalPrice());
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문 취소 시 상태는 CANCEL 이어야 한다.", OrderStatus.CANCEL, canceledOrder.getStatus());
